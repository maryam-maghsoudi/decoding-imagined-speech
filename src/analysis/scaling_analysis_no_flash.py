"""
scaling_analysis_no_flash.py
============================
Data-scaling analysis for a single img→lis MEG mapping architecture,
using MEG data without flash-onset removal.
...
Usage
-----
    python scaling_analysis_no_flash.py --model RNN_full
    python scaling_analysis_no_flash.py --model LinearLag_full --max_combos 10
    python scaling_analysis_no_flash.py --model CNN1D_windowed --heldout sub-01
    python scaling_analysis_no_flash.py --model RNN_full --save_models
...
Outputs (under scaling_out_no_flash/{model_key}/)
-------------------------------------------------
...
# =============================================================================
#  DATA LOADING  — flash windows are NOT removed
# =============================================================================
...
def load_all_subjects() -> Dict[str, np.ndarray]:
    ...
    for subj in SUBJECTS:
        ...
        data[subj] = load_meg_subject(subj)
    return data
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Data scaling analysis without flash-onset removal"
    )
...
def main():
    ...
    out_root = os.path.join("scaling_out_no_flash", model_key)
